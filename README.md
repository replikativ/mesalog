...
1.  [TL;DR](#org26ac286)
    1.  [Presentations](#orgf8a0d61)
2.  [Acknowledgements](#org87adfe1)
3.  [Quickstart](#org1b58b97)
4.  [Columns and attributes](#orgea5b46a)
5.  [Column identifiers](#org19f6cb2)
6.  [Including and excluding columns](#orgfb04608)
7.  [Supported column data types](#org65c1c6e)
8.  [Parsers vs. schema](#orga08d16d)
9.  [Parser descriptions](#orgdc08ee4)
10. [Schema description](#orgdc35788)
11. [Schema-on-read](#orge10f528)
12. [Cardinality inference](#org075e8ee)
13. [Attributes already in schema](#org94c5979)
14. [Reference-type attributes (with `:db/valueType` `:db.type/ref`)](#org174e629)
15. [Vector-valued columns](#org85f71c8)
16. [Tuples](#orga6e26bd)
17. [Options](#org06853fa)
18. [More examples](#org3dd8a74)
19. [Current limitations](#org4aa8772)
20. [License](#org33a9ba0)
...
-   Not too slow (improvements soon with any luck): ~45s per million rows to parse and infer schema.
    -   This is mostly for the record; it likely still leaves database transactions of the data as the performance bottleneck for most backends (though only [Datahike](https://github.com/replikativ/datahike) is currently supported).
    -   See `mesalog.demo` namespace for details.
-   Scalable: parser and schema inference on [35.5-million-row, 41-column](https://nycopendata.socrata.com/Social-Services/311-Service-Requests-from-2010-to-Present/erm2-nwe9/data) dataset in 15 minutes, and load in 10 hours 20 minutes with consistent resource usage and performance (see note above on DB transaction speed as bottleneck), on up to 10 3.0GHz cores.
...
<div class="html" id="orgae2bf9b">
<p>
&lt;a href=&ldquo;<a href="https://clojars.org/io.replikativ/mesalog">https://clojars.org/io.replikativ/mesalog</a>&rdquo;&gt;
  &lt;img alt=&ldquo;Build Status&rdquo; src=&ldquo;<a href="https://clojars.org/io.replikativ/mesalog"><img src="https://img.shields.io/clojars/v/io.replikativ/mesalog.svg" alt="mesalog.svg" class="org-svg" /></a>&rdquo; /&gt;
&lt;/a&gt;
</p>

</div>

<div class="html" id="org897cfbc">
<p>
&lt;a href=&ldquo;<a href="https://cljdoc.org/d/io.replikativ/mesalog">https://cljdoc.org/d/io.replikativ/mesalog</a>&rdquo;&gt;
  &lt;img alt=&ldquo;Build Status&rdquo; src=&ldquo;<a href="https://cljdoc.org/badge/io.replikativ/mesalog">https://cljdoc.org/badge/io.replikativ/mesalog</a>&rdquo; /&gt;
&lt;/a&gt;
</p>
...
See the section [Vector-valued columns](https://github.com/replikativ/mesalog?tab=readme-ov-file#vector-valued-columns) for details on specifying parser descriptions for vector-valued columns.
...
Mesalog supports schema-on-read databases, though not thoroughly, as noted in [Current limitations](https://github.com/replikativ/mesalog?tab=readme-ov-file#current-limitations) below.
...
2.  Its type and parser may be inferred or specified:
    ...
    -   The parser description for `"abc"` can take one of the forms described above for [Vector-valued columns](https://github.com/replikativ/mesalog?tab=readme-ov-file#vector-valued-columns), except `[dtype parse-fn]` as noted.
